...
VALUES
  ...
  ('home.hero.eyebrow', 'Hero: chamada superior', null, 'text', 'Acesso por curadoria', true, 'migration', now()),
  ('home.hero.pill', 'Hero: selo', null, 'text', 'Candidaturas abertas', true, 'migration', now()),
  ('home.hero.line1', 'Hero: linha 1', null, 'text', 'Dizem que', true, 'migration', now()),
  ('home.hero.line2', 'Hero: linha 2', null, 'text', 'o topo é', true, 'migration', now()),
  ('home.hero.highlight', 'Hero: destaque', null, 'text', 'solitário.', true, 'migration', now()),
  ('home.hero.line3', 'Hero: linha final', null, 'text', 'Nós discordamos.', true, 'migration', now()),
  ('home.hero.description', 'Hero: descrição', null, 'textarea', 'Um club empresarial fechado para fundadores, CEOs e executivos que querem crescer com pares certos, experiências de alto contexto e conversas que viram decisão.', true, 'migration', now()),
  ('home.hero.primaryCtaLabel', 'Hero: texto do botão principal', null, 'text', 'Candidatar-se ao club', true, 'migration', now()),
  ('home.hero.primaryCtaHref', 'Hero: link do botão principal', null, 'url', '/candidatura/', true, 'migration', now()),
